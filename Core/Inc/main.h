...
#define EncoderA_Right_Pin GPIO_PIN_0
#define EncoderA_Right_GPIO_Port GPIOA
#define EncoderB_Right_Pin GPIO_PIN_1
#define EncoderB_Right_GPIO_Port GPIOA
#define ADC_Snail_Pin GPIO_PIN_4
#define ADC_Snail_GPIO_Port GPIOA
#define Snail_Left_Pin GPIO_PIN_6
#define Snail_Left_GPIO_Port GPIOA
#define Snail_Right_Pin GPIO_PIN_7
...
#define EncoderB_Left_GPIO_Port GPIOA
