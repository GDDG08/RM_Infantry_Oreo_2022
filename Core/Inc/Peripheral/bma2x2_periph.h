 ...
 * @FilePath     : \Infantry_Oreo\Core\Inc\Peripheral\bma2x2_periph.h
 * @Descripttion :
 * @Author       : GDDG08
...
*/
#define BMA2x2_WR_FUNC_PTR int8_t (*bus_write)(uint8_t, uint8_t, uint8_t*, uint8_t)
...
#define BMA2x2_RD_FUNC_PTR int8_t (*bus_read)(uint8_t, uint8_t, uint8_t*, uint8_t)
#define BMA2x2_BRD_FUNC_PTR int8_t (*burst_read)(uint8_t, uint8_t, uint8_t*, uint32_t)
...
/**************************************************************/
#define BMA2x2_RETURN_FUNCTION_TYPE int8_t
 ...
 *
 *	@param slow_no_motion_uint8_t : The value of slow no motion interrupt
 *      enable
...
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_get_intr1_fifo_full(
    uint8_t* intr1_fifo_full_uint8_t);
/*!
 *	@brief This API is used to set
 *	the fifo full interrupt1 in the register 0x1A bit 2
 *
...
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_get_intr2_fifo_full(
    uint8_t* intr2_fifo_full_uint8_t);
/*!
 *	@brief This API is used to set
 *	the fifo full interrupt2 in the register 0x1A bit 5
 *
