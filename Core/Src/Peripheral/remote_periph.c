 ...
 * @FilePath     : \infantry_-neptune\Core\Src\Peripheral\remote_periph.c
 * @Descripttion :
 * @Author       : GDDG08
 * @Date         : 2021-12-31 17:37:14
 * @LastEditors  : GDDG08
 * @LastEditTime : 2022-03-24 19:55:54
 */
...
void Remote_RXCallback(UART_HandleTypeDef* huart) {
    ...
    int rxdatalen = Const_Remote_RX_BUFF_LEN - Uart_DMACurrentDataCounter(huart->hdmarx);
